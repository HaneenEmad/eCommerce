...
public class AdminMaintainProductsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        applyChangeBtn=findViewById(R.id.aplly_changes_btn);
        name=findViewById(R.id.product_item_product_name_maintain);
        price=findViewById(R.id.product_item_product_price_maintain);
        description=findViewById(R.id.product_item_product_description_maintain);
        imageView=findViewById(R.id.product_imageview_maintain);
