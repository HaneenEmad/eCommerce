            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()){
                    ...
                    if (shippingState.equals("shipped")){
                        ...
                        txtMsg1.setText("Congratulations, your final order has been shipped successfully. soon you will receive your door step.");
                        nextProcessBtn.setVisibility(View.GONE);

                        Toast.makeText(CartActivity.this, "you can purchase more products, once you received your first final products.",
